...
| **W-119** | Cloud Tunnel (ngrok) Bandwidth Guard | DONE | 2026-09-22 | Added `isTunnelConnection()` detection to disable auto-downloading 3D models over ngrok, reserving tunnel bandwidth for lightweight control commands while allowing local connections to load freely and offering an explicit "Load Anyway" override. |
